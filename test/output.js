...
var workers = [{ name: 'Benjamin', age: 25, nbHour: 35, alerte: function alerte() {
    return 'employ\xE9: ' + this.name + ', heures: ' + this.nbHour;
  } }, { name: 'Luc', age: 45, nbHour: 34, alerte: function alerte() {
    return 'employ\xE9: ' + this.name + ', heures: ' + this.nbHour;
  } }, { name: 'Marie', age: 23, nbHour: 35, alerte: function alerte() {
    return 'employ\xE9: ' + this.name + ', heures: ' + this.nbHour;
  } }, { name: 'Jeanne', age: 36, nbHour: 30, alerte: function alerte() {
    return 'employ\xE9: ' + this.name + ', heures: ' + this.nbHour;
  } }, { name: 'Jean', age: 37, nbHour: 35, alerte: function alerte() {
    return 'employ\xE9: ' + this.name + ', heures: ' + this.nbHour;
  } }];
